 ...
 */
export async function twitterRoutes(fastify) {
    /**
     * Initiate Twitter OAuth flow
     * GET /api/organizations/:id/twitter/auth
     */
    fastify.get('/api/organizations/:id/twitter/auth', {
     ...
     */
    fastify.get('/api/twitter/callback', async (request, reply) => {
     ...
     */
    fastify.get('/api/organizations/:id/twitter/account', {
        onRequest: [fastify.authenticate],
    }, async (request, reply) => {
        const { id: organizationId } = request.params;
        try {
     ...
     */
    fastify.delete('/api/organizations/:id/twitter/account', {
        onRequest: [fastify.authenticate],
    }, async (request, reply) => {
        const { id: organizationId } = request.params;
        try {
