...
import { createOrganizationSchema, updateOrganizationSchema, } from '@screeem/shared';
import { getUserOrganizations, getOrganizationById, getOrganizationBySlug, createOrganization, updateOrganization, deleteOrganization, checkUserOrgAccess, addOrganizationMember, } from '../../db/organizations.js';
export async function registerOrganizationRoutes(fastify) {
