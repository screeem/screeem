...
export class PostPublisher {
    ...
    async processScheduledPosts() {
        ...
        try {
            ...
            const result = await pool.query(`SELECT id, organization_id, content, media_urls, scheduled_for
    ...
    async publishPost(post) {
        ...
        try {
            ...
            await eventStore.append(organizationId, 'post-timeline', [
                {
            ...
            const twitterClient = createTwitterClient(twitterAccount.accessToken, twitterAccount.refreshToken || undefined);
            // Post to Twitter
